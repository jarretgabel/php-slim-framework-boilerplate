...
function CSS3MultiColumn() {
	...
	if(classes.indexOf('ie8') === -1 && classes.indexOf('ie9') === -1) {
		return;
	}
...
(function(doc, script) {
  var js,
    ...
    // Facebook SDK
    // add('//connect.facebook.net/en_US/all.js#xfbml=1&appId=556559374414789', 'facebook-jssdk');
    // Twitter SDK
  ...
  !function(d,s,id){var js,fjs=d.getElementsByTagName(s)[0];if(!d.getElementById(id)){js=d.createElement(s);js.id=id;js.src="https://platform.twitter.com/widgets.js";
  // ** INSERT HERE
  js.async = true;
  // ** END OF INSERT
